 ...
 *
 * Laeuft bei jedem Renderdurchgang ueber den bisher angekommenen Text. Waehrend
 * des Streamens kann eine Nummer noch unvollstaendig sein ("[1" ohne Klammer);
 * die bleibt dann Text und wird zum Verweis, sobald sie vollstaendig ist.
 */
